...
export function ChatInput({
  ...
  return (
    <div className="px-8 pb-8 pt-4 bg-gradient-to-t from-background via-background/80 to-transparent">
      <form
        onSubmit={(e) => {
          e.preventDefault();
          handleSubmit(e);
      ...
      >
        <div className="relative group">
          ...
          <div className="relative flex items-center gap-2 bg-muted/80 border border-border rounded-2xl p-2 pl-4 focus-within:border-accent-foreground/20 focus-within:bg-muted transition-all duration-200">
            <Input

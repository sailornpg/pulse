...
export function ChatHeader({
  ...
  return (
    <header className="h-16 border-b border-border flex items-center justify-between px-4 bg-background/72 backdrop-blur-xl z-20">
      ...
      <div className="flex items-center gap-4">
        <div className="flex -space-x-1.5">
          {[1, 2].map((i) => (
            ...
            >
              <AvatarFallback
                className={`text-[10px] font-bold ${i === 1 ? "bg-sky-500/10 text-sky-400" : "bg-primary/10 text-primary"}`}
              >
                {i === 1 ? "T" : "M"}
              </AvatarFallback>
            </Avatar>
